...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="flex flex-col lg:flex-row items-center">
            <div className="lg:w-1/2 mb-10 lg:mb-0">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button asChild size="lg" variant="outline" className="border-white text-yellow-400 bg-black ">
                  <Link href="/services">
      ...
      {/* CTA */}
      <section className="relative bg-[conic-gradient(at_left,_var(--tw-gradient-stops))] from-neutral-900 via-yellow-400 to-neutral-900 py-20 px-4 sm:px-6 lg:px-8 text-white">
